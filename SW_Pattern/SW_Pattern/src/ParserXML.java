...
//	                   System.out.println("Attr name : " + tempNode.getNodeName()+ "; Value = " + tempNode.getNodeValue());
	                   if(node.getNodeName() == "Subscribe") {    
	                	   ...
	                	   else if(tempNode.getNodeName() == "Operand3")
	                		   tempPubOperand3 = tempNode.getNodeValue();
	                	   else if(tempNode.getNodeName() == "Max")
	            ...
	            if(node.getNodeName() == "Subscribe") 
	        		 ...
	        		 pub.add(new Publisher(tempPubName, tempPubType, tempPubDefaultValue, tempPubOperation, tempPubOperand1, tempPubOperand2, tempPubOperand3, tempPubMax, tempPubMin ));
